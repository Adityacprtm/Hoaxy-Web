...
<head>
	...
	<link rel="icon" href="{{ asset('assets/mbeb/image/icon.png') }}">
	<!-- Strat of Facebook Meta -->
	<meta property="og:type" content="E-Greeting" />
	<meta property="og:image" content="{{ asset('assets/mbeb/image/favicon.ico') }}" />
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/mbeb/css/stylesheet.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/mbeb/css/loading.css') }}">
	<link href='https://fonts.googleapis.com/css?family=Signika' rel='stylesheet' type='text/css'>
	<!-- <link href='http://fonts.googleapis.com/css?family=Nunito' rel='stylesheet' type='text/css'> -->
	<link rel="stylesheet/less" href="{{ asset('assets/mbeb/css/cake.less') }}">
...
<body>
	...
	<audio class="song" controls loop>
		<source src="{{ asset('assets/mbeb/music/hbd.mp3') }}">
		</source>
	...
	<div class="balloons text-center" id="b5">
		<h2 style="color:#8377E4;">B</h2>
	</div>
	<div class="balloons text-center" id="b6">
		<h2 style="color:#99C96A;">E</h2>
	</div>
	<div class="balloons text-center" id="b7">
		<h2 style="color:#20CFB4;">B</h2>
	</div>

	<img src="{{ asset('assets/mbeb/image/Balloon-Border.png') }}" width="100%" class="balloon-border">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<img src="{{ asset('assets/mbeb/image/banner.png') }}" class="bannar">
			</div>
		</div>
		...
		<div class="row message">
			<div class="col-md-12">
				...
				<p>a very happy birthday <strong>Putri Mustika Sari</strong></p>
				<p>I'm Sorry & I Miss You So Bad...</p>
			</div>
		</div>
...
<script src="{{ asset('assets/mbeb/js/effect.js') }}"></script>
