...
<head>
	...
	<link rel="icon" href="{{ asset('assets/old/v1/images/icon.png') }}">

	<!-- Animate.css -->
	<link rel="stylesheet" href="{{ asset('assets/old/v1/css/animate.css') }}">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="{{ asset('assets/old/v1/css/icomoon.css') }}">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="{{ asset('assets/old/v1/css/bootstrap.css') }}">

	<!-- Theme style  -->
	<link rel="stylesheet" href="{{ asset('assets/old/v1/css/style.css') }}">

	<!-- Modernizr JS -->
	<script src="{{ asset('assets/old/v1/js/modernizr-2.6.2.min.js') }}"></script>

	<link rel="stylesheet" href="{{ asset('assets/old/v1/css/additional.css') }}">
...
<body>
			...
			<div class="choose animate-box">
				...
				<form action="" method="POST">
					...
					<div class="form-group">
						<input type="submit" value="Send Message" class="btn btn-primary" name="submit" disabled>
					</div>
				</form>
			</div>
		</div>
	...
	<!-- jQuery Easing -->
	<script src="{{ asset('assets/old/v1/js/jquery.easing.1.3.js') }}"></script>
	<!-- Bootstrap -->
	<script src="{{ asset('assets/old/v1/js/bootstrap.min.js') }}"></script>
	<!-- Waypoints -->
	<script src="{{ asset('assets/old/v1/js/jquery.waypoints.min.js') }}"></script>
	<!-- Stellar Parallax -->
	<script src="{{ asset('assets/old/v1/js/jquery.stellar.min.js') }}"></script>
	<!-- Easy PieChart -->
	<script src="{{ asset('assets/old/v1/js/jquery.easypiechart.min.js') }}"></script>


	<!-- Main -->
	<script src="{{ asset('assets/old/v1/js/main.js') }}"></script>
