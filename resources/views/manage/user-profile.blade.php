                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="text-center user-info">
                            <img src="{{ asset($user->avatar) }}" width="150" height="150" alt="avatar">
                            <p class="">{{ $user->name }}</p>
                        </div>
