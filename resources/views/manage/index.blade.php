...
<!-- Mirrored from designreset.com/cork/ltr/demo10/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 May 2020 07:37:54 GMT -->
            ...
            <div id="compact_submenuSidebar" class="submenu-sidebar">
                ...
                <div class="submenu" id="dashboard">
                    ...
                    <ul class="submenu-list" data-parent-element="#dashboard">
                        <li class="active">
                            <a href="index-2.html"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-pie-chart">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 layout-spacing">
                        <div class="widget widget-card-one">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{ asset('assets/manage/assets/img/profile-32.jpg') }}" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                        <h6>Jimmy Turner</h6>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{ asset('assets/manage/assets/img/g-8.png') }}" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="card-bottom-section">
                                    ...
                                    <div class="img-group">
                                        <img src="{{ asset('assets/manage/assets/img/profile-19.jpg') }}" alt="avatar">
                                        <img src="{{ asset('assets/manage/assets/img/profile-6.jpg') }}" alt="avatar">
                                        <img src="{{ asset('assets/manage/assets/img/profile-8.jpg') }}" alt="avatar">
                                        <img src="{{ asset('assets/manage/assets/img/profile-3.jpg') }}" alt="avatar">
                                    </div>
...
<!-- Mirrored from designreset.com/cork/ltr/demo10/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 May 2020 07:38:59 GMT -->
