...
<!-- Mirrored from designreset.com/cork/ltr/demo1/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 30 May 2020 07:37:29 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link href="{{ asset('assets/manage/assets/css/dashboard/dash_1.css') }}" rel="stylesheet" type="text/css" />
            ...
            <ul class="navbar-item flex-row ml-auto">
                ...
                <li class="nav-item dropdown language-dropdown">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{ asset('assets/manage/assets/img/ca.png') }}" class="flag-width" alt="flag">
                    </a>
