...
@section('title', 'Sidebar Category Editor')
						...
						<div class="widget-content widget-content-area">
							<div class="table-responsive mb-4">
								<table id="style-3" class="table style-3  table-hover">
									<button id="addCategorySidebar" type="button" class="btn btn-primary mt-1 mb-1 ml-3 mr-3"
		...
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="formModalLabel">Add Category Sidebar</h5>
				...
				<div class="modal-body">
					<form id="category-form" class="section general-info">
						<input type="hidden" name="category_sidebar_id" id="category_sidebar_id">
						<div class="widget-content widget-content-area">
							<div class="mb-4">
								<label for="category_sidebar_name">Category Name</label>
								<input type="text" class="form-control" name="category_sidebar_name" id="category_sidebar_name"
...
<script>
	...
	c3 = $('#style-3').DataTable({
				"processing": true,
				"serverSide": true,
				"ajax": "{{ route('manage.sidebar.category') }}",
				"columns": [
	...
	$('body').on('click', '.editCategorySidebar', function () {
		var data = c3.row( $(this).parents('tr') ).data();
		$('#formModal').modal('show');
      $('.modal-title').html("Edit Category");
      $('#saveBtn').html("Update");
      $('#category_sidebar_id').val(data.id);
		$('#category_sidebar_name').val(data.category_sidebar_name)
	});
	...
	$('#category-form').submit(function (e) {
      ...
      formdata.append('id', $("#category_sidebar_id").val());
		formdata.append('category_sidebar_name', $("#category_sidebar_name").val());

		$.ajax({
				url: "{{ route('manage.sidebar.category.update') }}",
				type: "POST",
				data: formdata,
				processData: false,
				contentType: false,
	...
	$('body').on('click', '.deleteCategorySidebar', function () {
		var data = c3.row( $(this).parents('tr') ).data();
		...
		swal({
				...
				if (result.value){
					$.ajax({
						type: "post",
						url: "{{ route('manage.sidebar.category.delete') }}",
						data: { id: category_sidebar_id},
						success: function (data) {
