		...
		<div class="row">
			...
			<div class="col-12 col-lg-6">
				<div class="case-item">
					...
					<svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-cloud text-primary mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-12 col-lg-6">
				<div class="case-item">
					...
					<svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-code-slash text-primary mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-12 col-lg-6">
				<div class="case-item">
					...
					<svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-hdd-network text-primary mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="col-12 col-lg-6">
				<div class="case-item">
					...
					<svg width="3em" height="3em" viewBox="0 0 16 16" class="bi bi-shield-shaded text-primary mb-3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="swiper-container js-carousel-clients">
			<div class="swiper-wrapper">
				...
				<div class="swiper-slide">
					<a target="_blank" href="{{ $client->url }}" title="{{ $client->title }}"><img src="{{ asset($client->image) }}" alt="Logo" /></a>
				</div>
				@endforeach
