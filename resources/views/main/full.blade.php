...
<body class="bg-triangles full-page">
	    ...
	    <div class="wrapper sticky-parent">
			...
			<div class="content">
		        ...
		        <div id="about-tab" class="tabcontent active">
				    <!-- About -->
				    <div id="about" class="section mt-0">
		        ...
		        <div id="resume-tab" class="tabcontent">
				    ...
				    <div class="section">
					    ...
					    <div class="timeline">
						    ...
						    <article class="timeline__item">
							    <h5 class="title title--h3 timeline__title">University School of the Arts</h5>
						    ...
						    <!-- Item -->
						    <article class="timeline__item">
							    <h5 class="title title--h3 timeline__title">New York Academy of Art</h5>
						    ...
						    <!-- Item -->
						    <article class="timeline__item">
							    <h5 class="title title--h3 timeline__title">High School of Art and Design</h5>
				    ...
				    <div class="section">
					    ...
					    <div class="timeline">
						    <!-- Item -->
						    <article class="timeline__item">
						    	<h5 class="title title--h3 timeline__title">Creative Director</h5>
						    ...
						    <!-- Item -->
						    <article class="timeline__item">
							    <h5 class="title title--h3 timeline__title">Art Director</h5>
						    ...
						    <!-- Item -->
						    <article class="timeline__item">
						    	<h5 class="title title--h3 timeline__title">Web Designer</h5>
			    ...
			    <!-- PORTFOLIO -->
		        <div id="portfolio-tab" class="tabcontent">
				    <div class="section mt-0">
    ...
    <ul class="slideNav">
	    <li class="slideNav__item rtl-mode"><h4 class="title title--5">More pages</h4></li>
