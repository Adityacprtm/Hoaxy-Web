<header class="header box">
	<div class="header__left">
		...
		<div class="header__base-info">
			...
			<ul class="header__social">
				<li><a target="_blank" href="{!! Info::where('key','LINK_FACEBOOK')->value('value') !!}" title="Facebook"><i
							class="font-icon icon-facebook1"></i></a></li>
				<li><a target="_blank" href="{!! Info::where('key','LINK_TWITTER')->value('value') !!}" title="Twitter"><i
							class="font-icon icon-twitter1"></i></a></li>
				<li><a target="_blank" href="{!! Info::where('key','LINK_INSTAGRAM')->value('value') !!}"
						title="Instagram"><i class="font-icon icon-instagram1"></i></a></li>
				<li><a target="_blank" href="{!! Info::where('key','LINK_LINKEDIN')->value('value') !!}" title="linkedIn"><i
							class="font-icon icon-linkedin1"></i></a></li>
				<li><a target="_blank" href="{!! Info::where('key','LINK_GITHUB')->value('value') !!}" title="Github"><i
	...
	<div class="header__right">
		...
		<ul class="header__contact">
			...
			<li><span class="overhead">CV</span><a target="_blank"
