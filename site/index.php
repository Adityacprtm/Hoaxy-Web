...
<head>
	...
	<meta name="google-site-verification" content="Wrho-Qz4I4FIq6ZuBCSaEtR8OZxBarvyq3UvMiTW_24" />
			...
			<div class="container">
				...
				<div class="row">
				    <div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/lobaha" class="work" style="background-image: url(images/portfolio-1.jpg);">
							<div class="desc">
								<h3>LoBaHa</h3>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Distributed-Computing-Systems" class="work" style="background-image: url(images/portfolio-2.jpg);">
							<div class="desc">
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Network-Programming" class="work" style="background-image: url(images/portfolio-3.jpg);">
							<div class="desc">
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Cryptography" class="work" style="background-image: url(images/portfolio-4.jpg);">
							<div class="desc">
								<h3>Cryptography</h3>
								<span></span>
							</div>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/FilkomApps-Dosen-Staff" class="work" style="background-image: url(images/portfolio-5.jpg);">
							<div class="desc">
                    ...
                    <div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Linear-Regression-Java" class="work" style="background-image: url(images/portfolio-6.jpg);">
							<div class="desc">
