...
<head>
	...
	<title>Aditya Chamim Pratama</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="" />
	<meta name="keywords" content="" />
	<meta name="author" content="Adityacprtm" />
...
<body>
	...
	<div id="page">
		<header id="hoaxy-header" class="hoaxy-cover js-fullheight" role="banner" style="background-image:url(images/cover-bg-5.jpg);"
							...
							<div class="display-tc js-fullheight animate-box" data-animate-effect="fadeIn">
								...
								<p>
									<ul class="hoaxy-social-icons">
										...
										<li><a target="_blank" href="https://www.adityacprtm.com"><i class="icon-sphere"></i></a></li>
									</ul>
								</p>
		...
		<div id="hoaxy-about" class="animate-box">
			<div id="about" class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center hoaxy-heading">
						<h2>About Me</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-5">
						<ul class="info">
							...
							<li><span class="first-block">Whatsapp:</span><span class="second-block">+62 878 1405 6616</span></li>
							<li><span class="first-block">Line:</span><span class="second-block">adityachamim</span></li>
							<li><span class="first-block">Email:</span><span class="second-block">aditya@adityacprtm.com</span></li>
					...
					<div class="col-md-7">
						...
						<p>Now, I'm taking a bachelor's degree at the faculty of computer science at brawijaya university focusing on network-based computing. And starting in 2018 I tried to start writing on the website. Besides on this website, you can download my CV <a href="#">here.</a></p>
						<p>Enjoy :)</p>
						<p>
							<ul class="hoaxy-social-icons">
								...
								<li><a href="mailto:aditya@adityacprtm.com"><i class="icon-mail3"></i></a></li>
		...
		<div id="hoaxy-resume" class="hoaxy-bg-dark">
					...
					<div class="col-md-12 col-md-offset-0">
						<ul class="timeline">
							...
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">Brawijaya University - 2015 - 2019<p>Malang, Indonesia</p></span>
									</div>
									<div class="timeline-body">
										<p>Focused on Network-Based Computing</p>
									</div>
								</div>
							</li>
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">SMA N 1 Banjarbaru - 2012 - 2015<p>Banjarbaru, Indonesia</p></span>
									</div>
									<div class="timeline-body">
										<p>I Majored in Science and found my love.</p>
									</div>
								</div>
							</li>
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">SMP N 1 Kuranji - 2009 - 2012<p>Tanah Bumbu, Indonesia</p></span>
									</div>
									<div class="timeline-body">
										<p>Here I am starting to be a little naughty, my mistake.</p>
									</div>
								</div>
							</li>
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										...
										<span class="company">SD N 1 Mustika - 2003 - 2009<p>Tanah Bumbu, Indonesia</p></span>
									</div>
									<div class="timeline-body">
										<p>The period when I was always ranked 1st in the class.</p>
									</div>
								</div>
							</li>
							...
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">Computer Network Practicum Assistant</h3>
							...
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">Chief Executive</h3>
							...
							<li class="animate-box timeline-unverted">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">Network Engineer (Internship)</h3>
							...
							<li class="timeline-inverted animate-box">
								...
								<div class="timeline-panel">
									<div class="timeline-heading">
										<h3 class="timeline-title">Social Community (SOSMA)</h3>
		...
		<!--
		<div id="hoaxy-features" class="animate-box">
		...
		<div id="hoaxy-skills" class="animate-box">
			<div id="skills" class="container">
				...
				<div class="row row-pb-md">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="78"><span><strong>Ruby</strong>78%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="80"><span><strong>Java</strong>80%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
						<div class="chart" data-percent="95"><span><strong>HTML</strong>95%</span></div>
					</div>
					<div class="col-md-3 col-sm-6 col-xs-12 text-center">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-1 progress-bar-striped active" role="progressbar" aria-valuenow="95"
						...
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-2 progress-bar-striped active" role="progressbar" aria-valuenow="80"
						...
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-3 progress-bar-striped active" role="progressbar" aria-valuenow="85"
					...
					<div class="col-md-6">
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-5 progress-bar-striped active" role="progressbar" aria-valuenow="83"
						...
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-1 progress-bar-striped active" role="progressbar" aria-valuenow="94"
						...
						<div class="progress-wrap">
							...
							<div class="progress">
								<div class="progress-bar progress-bar-3 progress-bar-striped active" role="progressbar" aria-valuenow="100"
		...
		<div id="hoaxy-work" class="hoaxy-bg-dark">
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center hoaxy-heading">
						<h2>Work</h2>
				...
				<div class="row">
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Distributed-Computing-Systems" class="work" style="background-image: url(images/portfolio-1.jpg);">
							<div class="desc">
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Network-Programming" class="work" style="background-image: url(images/portfolio-2.jpg);">
							<div class="desc">
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/Cryptography" class="work" style="background-image: url(images/portfolio-3.jpg);">
							<div class="desc">
								<h3>Cryptography</h3>
								<span></span>
							</div>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="https://github.com/Adityacprtm/FilkomApps-Dosen-Staff" class="work" style="background-image: url(images/portfolio-4.jpg);">
							<div class="desc">
					...
					<!--
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="#" class="work" style="background-image: url(images/portfolio-5.jpg);">
							<div class="desc">
								<h3>Project Name</h3>
								<span>Website</span>
							</div>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="#" class="work" style="background-image: url(images/portfolio-6.jpg);">
							<div class="desc">
								<h3>Project Name</h3>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="#" class="work" style="background-image: url(images/portfolio-7.jpg);">
							<div class="desc">
								<h3>Project Name</h3>
								<span>Brading</span>
							</div>
					...
					<div class="col-md-3 text-center col-padding animate-box">
						<a target="_blank" href="#" class="work" style="background-image: url(images/portfolio-8.jpg);">
							<div class="desc">
								<h3>Project Name</h3>
								<span>Illustration</span>
							</div>
		...
		<div id="hoaxy-blog">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4">
						<div class="hoaxy-blog animate-box">
		...
		<!--
		<div id="hoaxy-started" class="hoaxy-bg-dark">
			<div class="overlay"></div>
			<div class="container">
				<div class="row animate-box">
					<div class="col-md-8 col-md-offset-2 text-center hoaxy-heading">
						...
						<p><a href="#hoaxy-consult" class="btn btn-default btn-lg">Contact Us</a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div id="hoaxy-consult">
			<div class="video hoaxy-video" style="background-image: url(images/cover_bg_1.jpg);">
				<div class="overlay"></div>
			</div>
		...
		<script>
			function myMap() {
				...
				var myCenter = new google.maps.LatLng(-7.941308, 112.616413);
				var mapOptions = {
					center: myCenter,
					zoom: 13
				};
		...
		<!--<script type="text/javascript" charset="UTF-8">
			function addMarkersToMap(map) {
				var mlgMarker = new H.map.Marker({
					lat: -7.941308,
					lng: 112.616413
				});
				map.addObject(mlgMarker);
			}
			// Instantiate (and display) a map object:
			var platform = new H.service.Platform({
				app_id: 'hSOT9kuTZGuwBo24oFEK',
				app_code: 'VvXBeNCDwoNSnXdL8ZX9tQ'
			});
	...
	<div id="hoaxy-footer">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<p>&copy; 2018 Aditya Chamim Pratama. All Rights Reserved. <br>Designed by <a href="https://www.adityacprtm.com"
						 target="_blank">adityacprtm.com</a></p>
				</div>
			</div>
		</div>
	</div>
